...
def plot_disc_graph_least(values):
    ...
    ax.plot(positions, mapped_values, marker='o', linestyle='-', markersize=3,color='#5C63A2')  # Connect points with a line

    ax.set_title("Graph 2 | LEAST\n", fontsize=12, fontweight='bold')
    ax.set_title("Core, Private Self", fontsize=10, fontweight='normal', loc='right', color='gray')
